...
?>
    ...
    <div class="container">
        <?php include '../components/craft-sidebar.php'; ?>
        <section class="primary">
            ...
            <article class="article">
                ...
                <div class="thumbs">
                    <img width="400" height="266" src="../images/craft/thumb-military.jpg" alt="Photography of soldiers collecting ammo">
                </div>
            </article>
            <hr>
            <article class="article">
                ...
                <div class="thumbs">
                    <img width="400" height="266" src="../images/craft/thumb-ammo.jpg" alt="">
                </div>
            </article>
            <hr>
            <article class="article">
