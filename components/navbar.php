...
<div id="navigation" class="welcomeHide">
    <div class="left-nav">
        <span><a href="../index"><img class="logo" src="../images/navbar/logo-white.png" alt=""></a></span>
        <span><a href="../views/home"><img class="logo-resp" src="../images/navbar/logo-white.png" alt=""></a></span>
    </div>
    <div id="nav-separator"></div>
    <div class="right-nav">
        <span><a href="../views/home">HOME</a></span>
        <span><a href="../views/craft">CRAFTMANSHIP</a></span>
